...
describe("When something goes wrong at cludinary", function () {
    ...
    beforeEach(function (done) {
        ...
        uploadImageCommand.upload(testImageData).then(function (uploadResult) {
            result = uploadResult;
            done();
...
describe("When the file is uploaded", function () {
    beforeEach(function (done) {
        var testImageData = {
            fieldname: 'file',
            originalname: 'Me1.jpg',
    ...
    it("should be all good in the result", function () {
        expect(result).not.toBe(null);
