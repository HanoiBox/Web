...
describe("When there is no category data", function () {
	beforeEach(function () {
...
describe("When there is no category vietnamese description", function () {
	beforeEach(function () {
...
describe("When there is no category English description", function () {
	beforeEach(function () {
