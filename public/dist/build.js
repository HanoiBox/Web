...
$__System.register('5', ['3', '4'], function (_export) {
    ...
    return {
        ...
        execute: function () {
            _export('default', angular.module('indexControllerModule', [categoryQueryModule.name]).controller('IndexController', function ($location, $scope, allCategories) {

                this.allCategories = allCategories.data.categories;
                console.log(this.allCategories);
                this.topCategories = this.allCategories.filter(function (cat) {
                    return cat.level === 0;
                });
                console.log(this.topCategories);
                $scope.tabs = this.topCategories.map(function (cat) {
...
$__System.register('e', ['2', '4', '5', '8', 'd', 'a'], function (_export) {
  ...
  var indexTemplate, angular, indexControllerModule, loadingBar;
  return {
    setters: [function (_4) {
    ...
    execute: function () {
      _export('default', angular.module('appRoutesModule', ['ngRoute', 'angular-loading-bar', 'ui.bootstrap.dropdown', 'ui.bootstrap.tabs', indexControllerModule.name]).config(function ($routeProvider) {
...
$__System.registerDynamic("4", ["15"], true, function(req, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
$__System.register('16', ['4', '14', 'e'], function (_export) {
	'use strict';
