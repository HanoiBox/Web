...
var categoryCommand = function () {  
    ...
    let saveCategory = (categoryData, callback) => {
        ...
        let findAllCategoryPromise = new Promise(function (resolve, reject) {
		...
		findAllCategoryPromise.then(function (categories) {
			...
			categoryRepository.saveCategory(categoryData, (result) => {
